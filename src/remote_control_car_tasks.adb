...
package body Remote_Control_Car_Tasks is
   ...
   procedure Create_Package (Move : String);
   ...
   begin
      ...
      Ada.Synchronous_Task_Control.Set_True (Ready1);
      Ada.Synchronous_Task_Control.Set_True (Ready2);
   ...
   begin
      ...
      --  Representacion del coche para mostrar la distancia
   ...
   procedure Create_Package (Move : String) is
   begin
   ...
   begin
      ...
      loop
         ...
         if Flag_Send then
            LCD_Std_Out.Put (X => 1, Y => 1, Msg => "Mensaje " & Num_Messages'Img & " enviado");
   ...
   begin
      ...
      loop
         ...
         --  LCD_Std_Out.Put (X => 1, Y => 25, Msg => "Mensaje " & Num_Messages_Receives'Img & " recibido");
         --  Num_Messages_Receives := Num_Messages_Receives + 1;
         Update_Orientation (Receive_Message (40));
